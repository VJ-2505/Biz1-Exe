...
export class AuthService {
  ...
  last10transactions(storeid, companyid, invoiceno) {
    return this.http.get(
      this.base_url +
      `Receipt/last10transactions?storeid=${storeid}&companyid=${companyid}&invoiceno=${invoiceno}`,
    )
  }
  ...
  fetchDenominationEntries(storeid, date) {
    return this.http.get(
      this.base_url + `Denomination/getDenomEntry?storeid=${storeid}&date=${date}`,
    )
  }
  denominationTypes() {
  ...
  issockserverlive(ip) {
    return this.http.get(`http://${ip}:5000/issockserverlive`)
  }

  ////////waiter service
  getorderby_id(_id, otypeid) {
    return this.http.get(this.dburl + `issockserverlive?_id=${_id}&otypeid=${otypeid}`)
  }

  ///////////////////////////////////////////////<KOT>///////////////////////////////////////////////
  getkots(findquery) {
    return this.http.post(this.dburl + `getkots`, findquery)
  }
  savekot(kot) {
    return this.http.post(this.dburl + `savekot`, kot)
  }
  updatekot(kot) {
    return this.http.post(this.dburl + `updatekot`, kot)
  }
  deletekot(_id) {
    return this.http.get(this.dburl + `deletekot?_id=${_id}`)
  }
  ///////////////////////////////////////////////</KOT>///////////////////////////////////////////////
}
